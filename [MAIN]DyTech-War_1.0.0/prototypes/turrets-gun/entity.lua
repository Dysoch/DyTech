...
{
  {
    type = "ammo-turret",
    name = "sniper-turret",
    icon = "__[MAIN]DyTech-War__/graphics/turrets-gun/sniper-turret.png",
    ...
    prepared_animation =
    {
      filename = "__[MAIN]DyTech-War__/graphics/turrets-gun/gun-turret.png",
      priority = "medium",
      width = 178,
      height = 107,
      direction_count = 64,
    ...
    base_picture =
    {
      filename = "__[MAIN]DyTech-War__/graphics/turrets-gun/gun-turret-base.png",
      priority = "high",
      width = 43,
      height = 28,
      shift = { 0, -0.125 + 0.6 }
