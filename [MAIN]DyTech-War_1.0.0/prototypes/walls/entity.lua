...
{
  {
    type = "wall",
    name = "chitin-wall",
    icon = "__[MAIN]DyTech-War__/graphics/walls/chitin-wall.png",
  ...
  },
  {
    ...
    icon = "__[MAIN]DyTech-War__/graphics/walls/chitin-wall-remnants.png",
    flags = {"placeable-neutral", "player-creation"},
	order = "sw-r",
    selection_box = {{-0.5, -0.5}, {0.5, 0.5}},
  ...
  },
  {
    type = "wall",
    name = "sandwall",
    icon = "__[MAIN]DyTech-War__/graphics/walls/sandwall.png",
    flags = {"placeable-neutral", "player-creation"},
  ...
  },
  {
    ...
    icon = "__[MAIN]DyTech-War__/graphics/walls/sandwall-remnants.png",
    flags = {"placeable-neutral", "player-creation"},
	order = "sw-r",
    selection_box = {{-0.5, -0.5}, {0.5, 0.5}},
    selectable_in_game = false,
  ...
  },
  {
    type = "wall",
    name = "tungsten-wall",
    icon = "__[MAIN]DyTech-War__/graphics/walls/tungsten-wall.png",
    flags = {"placeable-neutral", "player-creation"},
  ...
  },
  {
    ...
    icon = "__[MAIN]DyTech-War__/graphics/walls/tungsten-wall-remnants.png",
    flags = {"placeable-neutral", "player-creation"},
	order = "sw-r",
    selection_box = {{-0.5, -0.5}, {0.5, 0.5}},
    selectable_in_game = false,
