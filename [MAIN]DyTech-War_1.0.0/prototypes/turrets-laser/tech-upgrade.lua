data:extend(
{
  ...
  },
  {
    ...
    prerequisites = {"laser-turret-damage-10"},
    unit =
    {
      count = 700,
      ingredients =
  ...
  },
  {
    ...
    prerequisites = {"laser-turret-damage-11"},
    unit =
    {
      count = 800,
      ingredients =
