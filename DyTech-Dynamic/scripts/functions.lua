...
glob.crafted.intermediates={
dytech=0, stick=0, wood=0, circuit1=0, circuit2=0, circuit3=0, circuit4=0, battery=0, cable=0, wirered=0, wiregreen=0, bundledwire=0, gear1=0, gear2=0, gear3=0, plastic=0, engine1=0, engine2=0, robotframe=0, explosives=0}
glob.crafted.guns={
...
glob.crafted.crafters={
dytech=0, assem1=0, assem2=0, assem3=0, pumpjack=0, refinery=0, chemical=0}
glob.crafted.logistics={
...
glob.crafted.others={
dytech=0, radar=0, lamp=0, port=0, wall=0, rocketdefense=0, beacon=0, plane=0}
end
