...
if glob.EventCheck.event001==true and glob.EventCheck.event002==true then
	...
	local LocaleName = game.getlocaliseditemname("science-pack-1")
		if not UnlockRecipe.enabled then 
			if glob.counter.science > math.random(125,300) and glob.counter.gear > math.random(450,1500) and glob.EventCheck.event003==true and game.player.force.technologies["steel-processing"].researched then
				if DynamicFailure(glob.counter.dytech) then
	...
	local LocaleName = game.getlocaliseditemname("basic-inserter")
		if not UnlockRecipe.enabled then 
			if glob.counter.inserter > math.random(450,900) and glob.counter.gear > math.random(750,3000) and glob.EventCheck.event005==true and game.player.force.technologies["steel-processing"].researched then
				if DynamicFailure(glob.counter.dytech) then
					fs.FailureReduction("inserter", 3)
					fs.FailureReduction("gear", 3)
					fs.FailureMessage(LocaleName)
	...
	local LocaleName = game.getlocaliseditemname("steel-furnace-mk2")
		if not UnlockRecipe.enabled then 
			if glob.counter.machine > math.random(150,400) and glob.counter.plates > math.random(150,1000) and glob.EventCheck015==true and game.player.force.technologies["advanced-material-processing"].researched then
				if DynamicFailure(glob.counter.dytech) then
	...
	local LocaleName = game.getlocaliseditemname("electric-furnace-mk2")
		if not UnlockRecipe.enabled then 
			if glob.counter.machine > math.random(150,400) and glob.counter.plates > math.random(150,1000) and glob.counter.tech > math.random(500,1000) and glob.EventCheck015==true and game.player.force.technologies["advanced-material-processing-2"].researched then
				if DynamicFailure(glob.counter.dytech) then
					fs.FailureReduction("machine", 10)
					fs.FailureReduction("plates", 10)
	...
	local LocaleName = game.getlocaliseditemname("basic-transport-belt")
		if not UnlockRecipe.enabled then 
			if glob.counter.belt > math.random(900,1800) and glob.counter.gear > math.random(1500,6000) and glob.EventCheck.event032==true and game.player.force.technologies["steel-processing"].researched then
				if DynamicFailure(glob.counter.dytech) then
