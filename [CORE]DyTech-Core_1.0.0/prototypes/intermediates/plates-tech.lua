data:extend(
{
  ...
  },
  {
    ...
    icon = "__[CORE]DyTech-Core__/graphics/metallurgy/lead/plate-icon.png",
    effects =
    {
      {
        type = "unlock-recipe",
  ...
  },
  {
    ...
    icon = "__[CORE]DyTech-Core__/graphics/metallurgy/gold/plate-icon.png",
    effects =
    {
      {
        type = "unlock-recipe",
