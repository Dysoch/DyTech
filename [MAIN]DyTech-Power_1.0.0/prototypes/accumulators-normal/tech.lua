...
{
  {
    ...
    prerequisites = {"electric-energy-accumulators-1", "capacitor-1", "frame-2"},
    unit =
    {
      count = 200,
      ingredients =
  ...
  },
  {
    ...
    prerequisites = {"electric-energy-accumulators-2", "capacitor-2", "frame-3"},
    unit =
    {
      count = 300,
      ingredients =
  ...
  },
  {
    ...
    prerequisites = {"electric-energy-accumulators-3", "capacitor-4", "frame-4"},
    unit =
    {
      count = 500,
      ingredients =
