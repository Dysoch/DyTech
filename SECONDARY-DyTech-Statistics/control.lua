...
remote.addinterface("DyTech-Statistics",
{
  ExportAll = function()
	game.makefile("DyTech-Timer.txt", serpent.block(glob.timer))
	game.makefile("DyTech-ChunkGenerated.txt", serpent.block(glob.ChunkGenerated))
	game.makefile("DyTech-SectorScanned.txt", serpent.block(glob.SectorScanned))
