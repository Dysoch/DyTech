data:extend(
{
  ...
  },
  {
    type = "furnace",
    name = "lava-heater",
    icon = "__[MAIN]DyTech-Machine__/graphics/metallurgy/machines/liquid-handler.png",
    ...
    animation =
    {
      filename = "__[MAIN]DyTech-Machine__/graphics/metallurgy/lava-heater/steel-furnace.png",
      priority = "high",
      width = 91,
      height = 69,
      frame_count = 1,
  ...
  },
  {
    ...
    animation =
    {
      filename = "__[MAIN]DyTech-Machine__/graphics/metallurgy/lava-cooler/steel-furnace.png",
      priority = "high",
      width = 91,
      height = 69,
      frame_count = 1,
