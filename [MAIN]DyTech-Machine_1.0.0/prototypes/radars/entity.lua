...
{ 
  {
    type = "radar",
    name = "radar-mk2",
    icon = "__[MAIN]DyTech-Machine__/graphics/radars/icon/radar-2.png",
    ...
    pictures =
    {
      filename = "__[MAIN]DyTech-Machine__/graphics/radars/radar-2.png",
      priority = "low",
      width = 153,
      height = 131,
  ...
  },
  {
    type = "radar",
    name = "radar-mk3",
    icon = "__[MAIN]DyTech-Machine__/graphics/radars/icon/radar-3.png",
    flags = {"placeable-player", "player-creation"},
    ...
    pictures =
    {
      filename = "__[MAIN]DyTech-Machine__/graphics/radars/radar-3.png",
      priority = "low",
      width = 153,
      height = 131,
      axially_symmetrical = false,
  ...
  },
  {
    type = "radar",
    name = "radar-mk4",
    icon = "__[MAIN]DyTech-Machine__/graphics/radars/icon/radar-4.png",
    flags = {"placeable-player", "player-creation"},
    ...
    pictures =
    {
      filename = "__[MAIN]DyTech-Machine__/graphics/radars/radar-4.png",
      priority = "low",
      width = 153,
      height = 131,
      axially_symmetrical = false,
  ...
  },
  {
    type = "radar",
    name = "radar-mk5",
    icon = "__[MAIN]DyTech-Machine__/graphics/radars/icon/radar-5.png",
    flags = {"placeable-player", "player-creation"},
    ...
    pictures =
    {
      filename = "__[MAIN]DyTech-Machine__/graphics/radars/radar-5.png",
      priority = "low",
      width = 153,
      height = 131,
      axially_symmetrical = false,
