...
data.raw["item"]["battery"].type = "ammo"
data.raw["item"]["battery"].magazin_size = 75
...
data.raw["item"]["battery"].ammo_type.action.action_delivery = { type = "projectile", projectile = "laser-ruby-1", starting_speed = 0.1 }
