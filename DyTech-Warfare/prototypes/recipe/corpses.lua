...
{ 
  ...
  },
  {
    ...
    category = "crafting-with-fluid",
    energy_required = 15,
    icon = "__DyTech-Warfare__/graphics/icons/biter-berserk-corpse.png",
    subgroup = "dytechbiteritems",
    ingredients =
    {
  ...
  },
  {
    ...
    category = "crafting-with-fluid",
    energy_required = 15,
    icon = "__DyTech-Warfare__/graphics/icons/biter-elder-corpse.png",
    subgroup = "dytechbiteritems",
    ingredients =
    {
  ...
  },]]--
  {
    ...
    category = "crafting-with-fluid",
    energy_required = 15,
    icon = "__DyTech-Warfare__/graphics/icons/biter-king-corpse.png",
    subgroup = "dytechbiteritems",
    ingredients =
    {
  ...
  },
  {
    ...
    category = "crafting-with-fluid",
    energy_required = 15,
    icon = "__DyTech-Warfare__/graphics/icons/biter-queen-corpse.png",
    subgroup = "dytechbiteritems",
    ingredients =
    {
