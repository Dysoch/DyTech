...
{
  {
    type = "ammo-turret",
    name = "sniper-turret",
    icon = "__DyTech-Graphics__/graphics/icons/sniper-turret.png",
    ...
    prepared_animation =
    {
      filename = "__DyTech-Graphics__/graphics/entity/gun-turret/gun-turret.png",
      priority = "medium",
      frame_width = 178,
      frame_height = 107,
      direction_count = 64,
    ...
    base_picture =
    {
      filename = "__DyTech-Graphics__/graphics/entity/gun-turret/gun-turret-base.png",
      priority = "high",
      width = 43,
      height = 28,
      shift = { 0, -0.125 + 0.6 }
  ...
  --[[RUBY TURRETS]]--
  {
    ...
    name = "laser-turret-2",
    icon = "__DyTech-Graphics__/graphics/icons/laser-ruby-2.png",
    ...
    base_picture =
    {
      filename = "__DyTech-Graphics__/graphics/entity/laser-turrets/laser-turret-base-2.png",
      priority = "high",
      width = 43,
      height = 28,
  ...
  },
  {
    type = "electric-turret",
    name = "laser-turret-3",
    icon = "__DyTech-Graphics__/graphics/icons/laser-ruby-3.png",
    flags = { "placeable-player", "placeable-enemy", "player-creation" },
    ...
    base_picture =
    {
      filename = "__DyTech-Graphics__/graphics/entity/laser-turrets/laser-turret-base-3.png",
      priority = "high",
      width = 43,
      height = 28,
      shift = { 0.109375, 0.03125 }
  ...
  --[[SAPPHIRE TURRETS]]--
  {
    type = "electric-turret",
    name = "laser-turret-4",
    icon = "__DyTech-Graphics__/graphics/icons/laser-sapphire-1.png",
    flags = { "placeable-player", "placeable-enemy", "player-creation" },
    ...
    prepared_animation =
    {
      filename = "__DyTech-Graphics__/graphics/entity/laser-turrets/laser-turret-sapphire.png",
      priority = "medium",
      frame_width = 131,
      frame_height = 72,
      direction_count = 64,
  ...
  },
  {
    type = "electric-turret",
    name = "laser-turret-5",
    icon = "__DyTech-Graphics__/graphics/icons/laser-sapphire-2.png",
    flags = { "placeable-player", "placeable-enemy", "player-creation" },
  ...
  },
  {
    type = "electric-turret",
    name = "laser-turret-6",
    icon = "__DyTech-Graphics__/graphics/icons/laser-sapphire-3.png",
    flags = { "placeable-player", "placeable-enemy", "player-creation" },
  ...
  --[[EMERALD TURRETS]]--
  {
    type = "electric-turret",
    name = "laser-turret-7",
    icon = "__DyTech-Graphics__/graphics/icons/laser-emerald-1.png",
    flags = { "placeable-player", "placeable-enemy", "player-creation" },
    ...
    prepared_animation =
    {
      filename = "__DyTech-Graphics__/graphics/entity/laser-turrets/laser-turret-emerald.png",
      priority = "medium",
      frame_width = 131,
      frame_height = 72,
      direction_count = 64,
  ...
  },
  {
    type = "electric-turret",
    name = "laser-turret-8",
    icon = "__DyTech-Graphics__/graphics/icons/laser-emerald-2.png",
    flags = { "placeable-player", "placeable-enemy", "player-creation" },
  ...
  },
  {
    type = "electric-turret",
    name = "laser-turret-9",
    icon = "__DyTech-Graphics__/graphics/icons/laser-emerald-3.png",
    flags = { "placeable-player", "placeable-enemy", "player-creation" },
