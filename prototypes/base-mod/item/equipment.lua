...
{
  {
    ...
    icon = "__DyTech-Graphics__/graphics/icons/basic-laser-defense-equipment-2.png",
  ...
  },
  {
    ...
    icon = "__DyTech-Graphics__/graphics/icons/basic-laser-defense-equipment-3.png",
