...
{  
	...
	Logger = function()
		game.makefile("DyTech/DataDump/Technologies.txt", serpent.block(global.Logger.Technology))
		game.makefile("DyTech/DataDump/RobotBuildEntity.txt", serpent.block(global.Logger.RobotBuildEntity))
		game.makefile("DyTech/DataDump/BuildEntity.txt", serpent.block(global.Logger.BuildEntity))
		game.makefile("DyTech/DataDump/PickedItems.txt", serpent.block(global.Logger.PickedItems))
		game.makefile("DyTech/DataDump/CanceledDeconstruction.txt", serpent.block(global.Logger.CanceledDeconstruction))
		game.makefile("DyTech/DataDump/MarkedForDeconstruction.txt", serpent.block(global.Logger.MarkedForDeconstruction))
		game.makefile("DyTech/DataDump/EntityDied.txt", serpent.block(global.Logger.EntityDied))
		game.makefile("DyTech/DataDump/RobotMinedItems.txt", serpent.block(global.Logger.RobotMinedItems))
		game.makefile("DyTech/DataDump/MinedItems.txt", serpent.block(global.Logger.MinedItems))
		game.makefile("DyTech/DataDump/CraftedItems.txt", serpent.block(global.Logger.CraftedItems))
		game.makefile("DyTech/DataDump/TimeStamp/RobotBuildEntity.txt", serpent.block(global.TimeStamp.RobotBuildEntity))
		game.makefile("DyTech/DataDump/TimeStamp/BuildEntity.txt", serpent.block(global.TimeStamp.BuildEntity))
		game.makefile("DyTech/DataDump/TimeStamp/PickedItems.txt", serpent.block(global.TimeStamp.PickedItems))
		game.makefile("DyTech/DataDump/TimeStamp/CanceledDeconstruction.txt", serpent.block(global.TimeStamp.CanceledDeconstruction))
		game.makefile("DyTech/DataDump/TimeStamp/MarkedForDeconstruction.txt", serpent.block(global.TimeStamp.MarkedForDeconstruction))
		game.makefile("DyTech/DataDump/TimeStamp/EntityDied.txt", serpent.block(global.TimeStamp.EntityDied))
		game.makefile("DyTech/DataDump/TimeStamp/RobotMinedItems.txt", serpent.block(global.TimeStamp.RobotMinedItems))
		game.makefile("DyTech/DataDump/TimeStamp/MinedItems.txt", serpent.block(global.TimeStamp.MinedItems))
		game.makefile("DyTech/DataDump/TimeStamp/CraftedItems.txt", serpent.block(global.TimeStamp.CraftedItems))
