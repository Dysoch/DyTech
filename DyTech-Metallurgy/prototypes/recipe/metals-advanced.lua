data:extend(
{
  ...
  {
    type = "recipe",
    name = "metallurgy-electrum-alloy",
	enabled = false,
	category = "forge",
    energy_required = 1.5,
    ingredients =
    ...
    results = 
	{
      {type="item", name="electrum-alloy", amount=1}
    },
  },
  {
    type = "recipe",
    name = "metallurgy-gunmetal-alloy",
	enabled = false,
	category = "forge",
    energy_required = 1.5,
    ingredients =
