for index, force in pairs(game.forces) do
	if force.technologies["energy-1"].researched then
		...
		force.recipes["offshore-pump-mk2"].enabled = true
	end
	if force.technologies["energy-2"].researched then
		...
		force.recipes["offshore-pump-mk3"].enabled = true
	end
	if force.technologies["energy-3"].researched then
		...
		force.recipes["offshore-pump-mk4"].enabled = true
	end
	if force.technologies["energy-4"].researched then
		...
		force.recipes["offshore-pump-mk5"].enabled = true
	end
